...
const JourneyBar = (props: PropsType) => {
  ...
  return (
    <div className="bg-gray-800 text-gray-100 w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out h-screen flex flex-col">
      {journey.map((item, i) => (
        <div
          key={i}
        ...
        >
          ...
          <span
            className={`${activeLink(item?.step)} ${
